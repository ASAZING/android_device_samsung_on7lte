...
TARGET_PREBUILT_KERNEL := device/samsung/on7elte/kernel
TARGET_PREBUILT_DTB := device/samsung/on7elte/dt.img

# Use this flag if the board has a ext4 partition larger than 2gb
BOARD_HAS_LARGE_FILESYSTEM := true
TARGET_USERIMAGES_USE_EXT4 := true
BOARD_SUPPRESS_SECURE_ERASE := true
BOARD_CUSTOM_BOOTIMG_MK :=  device/samsung/on7elte/bootimg.mk
...
TARGET_INIT_VENDOR_LIB := libinit_on7elte
TARGET_RECOVERY_DEVICE_MODULES := libinit_on7elte
TARGET_LIBINIT_DEFINES_FILE := device/samsung/on7elte/init/init_on7elte.cpp
